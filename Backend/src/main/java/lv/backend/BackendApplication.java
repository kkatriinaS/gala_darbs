...
public class BackendApplication {
	...
	public CommandLineRunner testModelLayer(IUserRepo userRepo, IParkingAreaRepo parkingAreaRepo,
			IParkingSpotRepo parkingSpotRepo, IReservationRepo reservationRepo, IAuthorityRepo authorityRepo, PasswordEncoder passwordEncoderSimple) {
		return new CommandLineRunner() {

			@Override
			public void run(String... args) throws Exception {
				User us1 = new User(0, "Janis", "janis123", passwordEncoderSimple.encode("000"), "janisp@gmail.com", null);
				User us2 = new User(0, "Ieva", "iozola", passwordEncoderSimple.encode("1188"), "ievao@gmail.com", null);
